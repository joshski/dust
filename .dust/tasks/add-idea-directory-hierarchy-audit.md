# Add Idea: Directory Hierarchy Audit
...
Add an audit that reviews the directory hierarchy in the repository and suggests ideas for improving it: making it more consistent, creating directories that better reflect logical groupings, removing unnecessary directories.
