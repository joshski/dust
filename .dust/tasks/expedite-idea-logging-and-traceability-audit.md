# Expedite Idea: Logging and Traceability Audit
...
Add an audit that specifically covers:
* is it easy to understand what’s happening when the application runs?
* is it easy for agents and humans to use logs to diagnose issues at development time?
