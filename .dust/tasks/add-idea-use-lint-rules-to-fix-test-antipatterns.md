# Add Idea: Use lint rules to fix test antipatterns
...
Review tests for anti patterns that we can fix with lint rules (ideally oxlint). For each anti pattern, create an idea.
