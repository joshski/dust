# Build Idea: Add Ubiquitous Language Audit
...
Add an audit that covers "Ubiquitous Language":

do recent changes deviate from the accpeted terminology?
is the naming consistent between code, user interface, and documentation?
