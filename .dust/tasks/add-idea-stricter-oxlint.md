...
Enable oxlint rules that are likely to improve the quality of code and reduce bugs. Start with the highest value rules and create ideas for enabling any rules that require a lot of changes to the code
