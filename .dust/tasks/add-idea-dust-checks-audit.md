...
When dust is added to a repository, checks need to be configured. Add an audit that suggests the appropriate checks for the given tech stack. It should include (where appropriate)
* Lints and other static analysis
* Type checking
* Compilation
* Unit tests
* System tests
...
The audit should create ideas for any missing checks
