...
Git history includes task deletions, so it acts as a kind of “archaeology source”. But some people don’t want such commits. How can we still use git to store dust artifact transitions without polluting the main git history?
