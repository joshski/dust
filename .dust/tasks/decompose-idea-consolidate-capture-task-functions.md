...
**Decision:** Option: Deprecate and remove


## Decomposes Idea

- [Consolidate Capture Task Functions](../ideas/consolidate-capture-task-functions.md)
