# Add Idea: Incidental Test Details Audit
...
Add an audit that reviews tests for "incidental details" that are not pertinent to the test, hide intent and make the tests more likely to fail for incidental reasons. The audit should suggest individual ideas for improving tests with incidental details.
