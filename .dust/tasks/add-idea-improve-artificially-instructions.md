# Add Idea: Improve artificially instructions
...
Agents make mistakes writing artifacts relatively frequently. Maybe we can give better advice - e.g. do we always mention the opening sentence should be short and punchy?
