# Add Idea: Audits from principles
...
Consider the dust core principles. Are there any stock audits that could be created to evaluate whether a downstream repository adheres to each given principle?
