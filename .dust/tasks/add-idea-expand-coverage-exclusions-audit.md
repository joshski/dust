# Add Idea: Expand coverage exclusions audit
...
The coverage exclusions audit should include both configuration files and inline coverage exceptions (usually code comments)
