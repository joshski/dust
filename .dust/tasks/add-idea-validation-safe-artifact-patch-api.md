# Add Idea: Validation-safe artifact patch API
...
Downstream consumers of dust need to make complex “patches” to artifacts which span many files. Since artifacts can be interrelated, doing this safely (such that dust validation does not fail after applying the patch) requires a dedicated API in dust itself. Ideally this would expose relationships between artifacts as objects rather than markdown
