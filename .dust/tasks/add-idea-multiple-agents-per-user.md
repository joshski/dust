# Add Idea: Multiple agents per user
...
Allow users to split work between multiple agent machines, potentially with different capabilities. What needs to change in the dust bucket protocol (if anything) to support this? Could the server already allocate work to different agents based on their connection parameters?
