# Add Idea: Test Assertions Audit
...
Add an audit about test assertions:
* prefer close to one assertion per test
* assertions should reveal failure reasons
* assertions should be deterministic
* assertions should be precise but not necessarily exhaustive
* assertions should avoid fixed delays in tests
