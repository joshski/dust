# Add Idea: Environment Configuration Audit
...
Add an audit that reviews environment variables and other environment-specific configuration. It should look for inconsistency, potential errors as a side-effect of misconfiguration, and opportunities to improve configurability. Each issue should trigger the creation of a new idea.
