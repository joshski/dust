# Build Idea: Show bot icon on button in "Refine" dialog
...
The refine dialog should have a bot icon and the text "Refine it!". Perhaps we need to extract a component for buttons which have the bot icon on, so we can ensure consistency
