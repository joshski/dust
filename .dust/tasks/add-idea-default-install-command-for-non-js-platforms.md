# Add Idea: Default install command for non-js platforms
...
We assume the install command for a given repository must be node.js — but what if it’s a rails or other project? Should we show an error, or guess?
