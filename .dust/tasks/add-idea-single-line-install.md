...
Running `dust bucket worker` should be simpler. A single command line should be all you need to run an agent. The installable package should self-update.
