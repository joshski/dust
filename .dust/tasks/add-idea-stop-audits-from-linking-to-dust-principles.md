# Add Idea: Stop audits from linking to dust principles
...
Tasks generated by audits contain links to principles that live in dust itself. We don't have an inheritance mechanism for those yet, so dust is generating invalid task files...
