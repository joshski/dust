# Add Idea: Support docker compose
...
Some applications need a whole set of interconnected services for development. Support docker compose under ./.dust/config/container
