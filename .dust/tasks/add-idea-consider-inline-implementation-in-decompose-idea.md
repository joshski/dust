# Add Idea: Consider inline implementation in decompose idea
...
When decomposing an idea, the plan is often laid out in detail. Why bother creating tasks for it in these cases? We could allow the agent to use its judgement and only create tasks if it can think of more than one?
