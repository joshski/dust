# Add Idea: Prevent certain tasks from escaping .dust directory
...
Audit tasks (and potentially other tasks) are not intended to update anything outside the .dust directory. This should be clear in the instructions and definition of done for those tasks, but we can also presumably prevent unwanted changes with the git hook
