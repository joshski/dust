# Add Idea: Reference-safe task deletion
...
There is a “changeset” API of sorts. But we should expose an API for deleting a task and removing all references to it.
