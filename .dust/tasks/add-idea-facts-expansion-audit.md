# Add Idea: Facts Expansion Audit
...
Add an audit to check whether all significant facts about the codebase (that aren't obvious by scanning the code or with a prior understanding of the frameworks and libraries used) are included in .dust/facts

The audit should suggest creating an idea for each fact that is likely to be useful to a future agent working on a particular area of the code
