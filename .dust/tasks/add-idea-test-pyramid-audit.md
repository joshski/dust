...
Add an audit which determines if tests are optimally organised according to the “test pyramid” pattern, where a large number of small, fast tests is considered to be optimal (versus a small number of slow, broad tests).
