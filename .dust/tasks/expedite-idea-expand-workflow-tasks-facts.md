# Expedite Idea: Expand workflow tasks facts
...
Workflow tasks (including “New Idea” and “Expedite Idea”) are quite hard to understand. Split up the facts and add examples.
