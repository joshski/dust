# Add Idea: Review bucket contracts
...
Is it clear for implementers of the “bucket protocol” exactly what their responsibility is? Can we export any other types for implementations to ensure conformance?
