# Add Idea: Implement-then-review chains
...
The instructions for a single session include pushing the code to the remote repository. But what if we want a single atomic change to involve a series of sessions, e.g. 1 implementation 2 review UX, 3 review tests, 4 push.
