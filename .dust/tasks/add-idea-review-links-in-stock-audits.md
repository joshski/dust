# Add Idea: Review links in stock audits
...
Markdown links from stock audits (e.g. to core principles) will fail in downstream repositories if they are relative.

Remove links from stock audits to other dust artifacts, and briefly inline the intent of the linked-to artifact into the audit text.
