# Add Idea: Less nullables and optionals
...
Look for opportunities to remove optional or nullable properties and arguments, where making them mandatory means we can be less defensive.
