# Add Idea: Queue order is entirely decided by blocking
...
Instead of complex logic for determining queue order based on commit times etc, we could use Blocked by to make it "strucutrally deterministic"
