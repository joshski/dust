# Add Idea: Alternative names for dust bucket worker
...
Worker seems like the wrong name for a service that spawns containers to perform work (those feel like the “workers”)
