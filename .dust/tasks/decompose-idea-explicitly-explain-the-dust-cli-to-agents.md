...
- [Explicitly explain the dust CLI to agents](../ideas/explicitly-explain-the-dust-cli-to-agents.md)
...
- The original idea (.dust/ideas/explicitly-explain-the-dust-cli-to-agents.md) is deleted or updated to reflect remaining scope
