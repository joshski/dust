# Add Idea: Strict .dust directory allowance
...
Only allow approved files under `.dust/` directory -- don't allow users to add arbitrary files there. Fail the built in lint if they violate the rule.
