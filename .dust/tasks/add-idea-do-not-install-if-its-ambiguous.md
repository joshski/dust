# Add Idea: Do not install if it’s ambiguous
...
If we cannot auto detect how to install dependencies automatically, we should not fail over to `npm install`. That’s just weird.

Perhaps we should perform _all_ installers if doubt?
