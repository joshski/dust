# Add Idea: Allow audits with ad-hoc details
...
When an audit is created, allow the user to specify additional details, like specific files or commits to consider
