# Add Idea: Simplify installation instructions
...
Since dust inherently requires a coding agent, we should lean into that in the installation instructions.

E.g. tell humans to run:

claude “install dust as per <github URL>”
