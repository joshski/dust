# Add Idea: Prevent fixed sleeps in tests
...
Use a linter to catch instances of sleeping in tests, or fixed sleeps in general. Make them fail lint. Maybe there are existing oxlint rules for this?
