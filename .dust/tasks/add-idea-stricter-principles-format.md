# Add Idea: Stricter principles format
...
Improve the formatting of principles:

1. Remove empty "Sub-Principles" section (if a principle has no sub-principles, it cannot have this section)
2. Ensure "Parent Principle" and "Sub-Principles" are the last sections in the document
