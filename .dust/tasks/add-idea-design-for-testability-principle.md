# Add Idea: Design for Testability principle
...
Dust unashamedly designs for testability - which happens to produce decoupled code, which is easy to extend and maintain. Add a principle that captures this
