# Add Idea: Iterate on an arbitrary branch
...
When the dust bucket server provides a list of repositories it should also provide a branch name. All git checkouts and commits should be made against the given branch.
