# Expedite Idea: Fix 5 "low hanging fruit" coverage gaps
...
Search the tests for coverage gaps. Add coverage or restructure the code for 5 of them, such that we have 5 less gaps.
