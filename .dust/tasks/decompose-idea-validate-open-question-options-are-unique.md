...
- [Validate open question options are unique](../ideas/validate-open-question-options-are-unique.md)
...
- The original idea (.dust/ideas/validate-open-question-options-are-unique.md) is deleted or updated to reflect remaining scope
