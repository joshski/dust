# Add Idea: Ensure no audits recommend creating tasks
...
No audits should ever recommend creating tasks. The output of audits should be ideas. Review the stock audits. Also add an audit for auditing audits!
