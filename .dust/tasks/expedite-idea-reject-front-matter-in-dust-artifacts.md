# Expedite Idea: Reject front matter in dust artifacts
...
Dust artifacts should never contain front matter. Nothing should precede the title. Include this check in artifact validation
