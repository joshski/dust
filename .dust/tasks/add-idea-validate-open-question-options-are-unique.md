# Add Idea: Validate open question options are unique
...
Within any Open Questions section of a dust idea, the options (headings) must be unique strings. Add this validation rule
