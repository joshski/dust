# Add Idea: Explicitly mention "tasks means dust tasks"
...
Occasionally when given the instructions to "add a task" in interactive sessions, agents will add a task to their own internal task tracking system and not dust. Add some more direct instructions to `dust agent` to use dust when defining tasks.
