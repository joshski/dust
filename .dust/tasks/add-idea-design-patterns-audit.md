# Add Idea: Design patterns audit
...
Add an audit which suggests refactoring to recognized design patterns - one idea per refactoring opportunity - including the trade off associated with each change
