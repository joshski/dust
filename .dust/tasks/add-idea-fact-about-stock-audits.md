# Add Idea: Fact about stock audits
...
Write a fact about stock audits, especially as a guide to writing good audits:

* Stock audits are included in the dust package
* Stock audits are primarily for downstream consumers
* They should be domain and tech stack agnostic
