# Add Idea: Allow resolving open questions during refinement
...
When an idea is refined, accept an optional argument which allows open questions to be resolved
