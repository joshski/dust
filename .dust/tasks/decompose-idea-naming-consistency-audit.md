...
**Decision:** Option: New `naming-consistency` audit

### How aggressive should rename recommendations be?

**Decision:** Option: High-confidence only


## Decomposes Idea

- [Naming Consistency Audit](../ideas/naming-consistency-audit.md)
