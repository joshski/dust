# Add Idea: Promote dust commands over .dust directory exploration
...
In some task templates we hint towards using a glob to review raw artifact files:

----
Review `.dust/principles/` and `.dust/facts/` for relevant context.
---

...but we have specialised commands for reviewing those, e.g.

`{dustCommand} principles`
`{dustCommand} facts`

We should encourage agents to use those, since they provide richer feedback.
