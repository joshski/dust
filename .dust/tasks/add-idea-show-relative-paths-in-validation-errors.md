# Add Idea: Show relative paths in validation errors
...
In validation errors we show fully qualified paths. But the full path is noise. We can show paths relative to cwd.
