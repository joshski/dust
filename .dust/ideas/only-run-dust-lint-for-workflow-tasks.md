...
These task types are already identified by their title prefixes in [[`lib/artifacts/workflow-tasks.ts`](../../lib/artifacts/workflow-tasks.ts)](../../lib/artifacts/workflow-tasks.ts):
...
In [[`lib/cli/commands/pre-push.ts`](../../lib/cli/commands/pre-push.ts)](../../lib/cli/commands/pre-push.ts), when the commits being pushed only contain [`.dust/`](..) file changes and the task is a workflow task:
...
**Decision:** In [[`lib/artifacts/workflow-tasks.ts`](../../lib/artifacts/workflow-tasks.ts)](../../lib/artifacts/workflow-tasks.ts)
...
1. **[[`lib/artifacts/workflow-tasks.ts`](../../lib/artifacts/workflow-tasks.ts)](../../lib/artifacts/workflow-tasks.ts)** - Add `isWorkflowTask(taskTitle: string): boolean` helper
2. **[[`lib/cli/commands/focus.ts`](../../lib/cli/commands/focus.ts)](../../lib/cli/commands/focus.ts)** - Detect workflow tasks and provide tailored instructions
3. **[[`lib/cli/commands/pre-push.ts`](../../lib/cli/commands/pre-push.ts)](../../lib/cli/commands/pre-push.ts)** - Add [`.dust/`](..)-only detection, conditionally call `lintMarkdown` instead of `check`
