...
Ideas, goals, facts, and tasks should each be as discrete and fine-grained as possible.
...
Note: This goal directly supports [Lightweight Planning](lightweight-planning.md), which explicitly mentions that "Tasks are small and completable in single commits."
