...
Dust's internal development scripts use [Bun](https://bun.sh) as the JavaScript/TypeScript runtime. Bun provides fast startup times and native TypeScript execution without a separate compilation step, supporting the [Fast Feedback](../principles/fast-feedback.md) goal.
