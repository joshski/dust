...
The hierarchy has one root principle: **Agentic Flow State** (with `## Parent Principle` of `(none)`). This root has two sub-principles: **Maintainable Codebase** (how we develop dust) and **Human-AI Collaboration** (what dust offers users).
