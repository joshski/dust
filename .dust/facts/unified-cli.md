...
This follows the familiar pattern of tools like `git` and `docker`, supporting [Easy Adoption](../principles/easy-adoption.md). Run `dust help` to see all available commands.
