...
11. Run \`dust lint\` to catch any issues with the task format
...
13. **Start a sub-agent** to implement the task: "Run \`dust implement task\` and implement the task in \`.dust/tasks/[task-file].md\`"`)
